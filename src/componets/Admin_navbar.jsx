            ...
            <nav className="navbar navbar-expand-lg navbar-light bg-white border-bottom sticky-top py-3">
                <div className="container-fluid">
                    ...
                    <div className="collapse navbar-collapse" id="adminNavbar">
                        ...
                        {/* CENTER SEARCH */}
                        <form className="mx-auto my-2 my-lg-0" style={{ width: "40%", minWidth: '250px' }}>
                        ...
                        <ul className="navbar-nav align-items-center">
                            ...
                            <li className="nav-item mx-2">
                                <Link className="nav-link fw-semibold px-3" to="/dashboard">Dashboard</Link>
                            </li>

                            {/* PROFILE TRIGGER */}
                            <li className="nav-item ms-lg-3 mx-2">
                                <div role="button"data-bs-toggle="modal" data-bs-target="#Profilemodal"className="d-flex align-items-center bg-light p-1 pe-3 rounded-pill border" >
                                    <img 
                                        src={profile} 
                    ...
                    <div className="modal-content border-0 shadow-lg">
                        <div className="modal-body text-center p-4">
                            ...
                            <div className="d-grid gap-2">
                                ...
                                <button className="btn btn-link btn-sm text-danger text-decoration-none" onClick={()=>logout()}>Logout</button>
                            </div>
                        </div>
                    </div>
                </div>
